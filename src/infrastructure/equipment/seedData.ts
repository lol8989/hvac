...
// 유형 라벨은 출처 스펙시트와 0708 장비번호 규칙(1WAY=C · 2WAY=G · 4WAY=T)을 따른다.
// 이전 시드는 C계열을 '4WAY 카세트', T계열을 '덕트'로 잘못 표기했고 장비번호만 맞았다.
// (RNW0201C2S의 출처 시트는 '프리미엄1Way', RNW0401A2U는 '4WAY 듀얼베인'.) 주인님 정정 2026-07-10.
const ONE_WAY = '1WAY 카세트'
const TWO_WAY = '2WAY 카세트'
...
const INDOOR_SEED: ReadonlyArray<[string, string, number, number, string]> = [
  // C시리즈 (1WAY 카세트)
  ['20C', 'RNW0201C2S', 2000, 2200, ONE_WAY],
  ['23C', 'RNW0231C2S', 2300, 2600, ONE_WAY],
  ['32C', 'RNW0321C2S', 3200, 3600, ONE_WAY],
  ['40C', 'RNW0401C2S', 4000, 4500, ONE_WAY],
  ['52C', 'RNW0521C2S', 5200, 5900, ONE_WAY],
  ['60C', 'RNW0601C2S', 6000, 6800, ONE_WAY],
  ['72C', 'RNW0721C2S', 7200, 7200, ONE_WAY],
  // G시리즈 (2WAY 카세트) — 실물 민수전용 라인업. 2WAY는 52·60·72만 존재한다.
  ['52G', 'RNW0521G2S', 5200, 5900, TWO_WAY],
  ['60G', 'RNW0601G2S', 6000, 6800, TWO_WAY],
  ['72G', 'RNW0721G2S', 7200, 8100, TWO_WAY],
  // T시리즈 (4WAY 카세트)
  ['40T', 'RNW0401A2U', 4000, 4500, CASSETTE],
  ['52T', 'RNW0521A2U', 5200, 5900, CASSETTE],
  ['60T', 'RNW0601A2U', 6000, 6800, CASSETTE],
  ['72T', 'RNW0721A2U', 7200, 8100, CASSETTE],
  ['83T', 'RNW0831A2U', 8300, 9300, CASSETTE],
  ['100T', 'RNW1001A2U', 10000, 11200, CASSETTE],
  ['110T', 'RNW1101A2U', 11000, 12400, CASSETTE],
  ['130T', 'RNW1301A2U', 13000, 14600, CASSETTE],
  ['145T', 'RNW1451A2U', 14500, 16300, CASSETTE],
]
